...
var pool = module.exports = function pool(options, authorizeFn) {
    ...
    function GetBlockTemplateParameters() {
        if (options.coin.passAlgorithm) {
            return [{ "capabilities": ["coinbasetxn", "workid", "coinbase/append"], "rules": ["mweb", "segwit"] }, options.coin.passAlgorithm === true ? options.coin.algorithm : options.coin.passAlgorithm];
            return [{ "mode": "template", "capabilities": ["coinbasetxn", "workid", "coinbase/append"], "rules": ["mweb", "segwit"] }, options.coin.passAlgorithm === true ? options.coin.algorithm : options.coin.passAlgorithm];
        } else if (options.coin.passAlgorithmKey) {
            return [{ "capabilities": ["coinbasetxn", "workid", "coinbase/append"], "rules": ["mweb", "segwit"], "algo": options.coin.passAlgorithmKey === true ? options.coin.algorithm : options.coin.passAlgorithmKey }];
            return [{ "mode": "template", "capabilities": ["coinbasetxn", "workid", "coinbase/append"], "rules": ["mweb", "segwit"], "algo": options.coin.passAlgorithmKey === true ? options.coin.algorithm : options.coin.passAlgorithmKey }];
        }
        return [{ "capabilities": ["coinbasetxn", "workid", "coinbase/append"], "rules": ["mweb", "segwit"] }];
        return [{ "mode": "template", "capabilities": ["coinbasetxn", "workid", "coinbase/append"], "rules": ["mweb", "segwit"] }];
    }
